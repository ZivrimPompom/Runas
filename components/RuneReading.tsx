                    ...
                    <div key={`result-${index}`} className={cn("flex flex-row items-center gap-2", gridClass)}>
                      ...
                      {isFlipped[index] && (
                        <motion.div 
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          className="text-center space-y-1 bg-white dark:bg-stone-900 p-2 rounded-2xl shadow-md border border-stone-50 dark:border-stone-800 max-w-[150px] relative z-20 mt-5"
                        >
